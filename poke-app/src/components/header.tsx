    ...
    <>
      <div className="flex justify-between pt-8 md:pt-10 pl-4 md:pl-10 flex-wrap lg:flex-nowrap">
        <div className="flex items-center mb-4 w-full md:w-auto md:mr-2">
          <h1 className="text-center text-3xl md:text-5xl tracking-wider mr-4 md:mr-8">pokeccha</h1>
          <h2 className="text-center text-sm md:text-xl tracking-wider leading-loose">Pick your favorite Pokemon!</h2>
        </div>
